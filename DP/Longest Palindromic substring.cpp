//Intuituion : all 1 len substrings are palindrome and 2 len substrings are palindrome if both equal
// rest strings of len>=3 are palindrome if starting and ending index are same char and inside string is palindrome
